function [thinnedpic] = EdgeDetectObject(image)
%%Rod Dockter
%%Arguments: 
...
%%assignment # 1 which I will reuse for the perimeter finding portion of
%%the object recognition code

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%Input image will just be the double image of objects from the main
%%bit of perimeter finding
magthreshold=0.3;
expansionnum = 1;
picg= image;
[row,col]=size(image);
