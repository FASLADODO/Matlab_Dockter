...
for t = 1:10
    t
    [Model] = TrainDPPGrid(Data,Labels,11);
end
toc
...
for t = 1:10
    t
    [Class,ClassTime,ScoreTime] = OnlineDPPGrid(DataOn,Model);
end
toc
...
%kappa=1.1 gets 92.9% time, 100%overall classification, 10 % convergence
%time
