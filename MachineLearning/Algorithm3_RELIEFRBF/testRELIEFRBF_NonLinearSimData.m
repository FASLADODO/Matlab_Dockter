% test classification using reliefrbf on nonlinear simulated data
...
%kappa=1.1 gets 77% time, 100%overall classification, 36 % convergence
%time
%kappa=1.2 gets 75% time, 100%overall classification, 33 % convergence
