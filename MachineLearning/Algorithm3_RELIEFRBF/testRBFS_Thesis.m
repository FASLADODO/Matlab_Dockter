...
[Diffz,Dataz,Labelz] = GPRSubrank(Data,Labels);
...
%modified version for online trajectories
[Class,ClassTime,ScoreTime,mu]= GPRClassifyOnline(GPRMDL,Data);

classest = sign(mu);

figure
scatter(Data(:,1),Data(:,2),10,mu);
xlabel('x','FontSize',fsize)
ylabel('y','FontSize',fsize)
colormap(flipud(cool))
hc = colorbar;
