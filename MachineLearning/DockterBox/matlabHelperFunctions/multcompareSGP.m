function [comparison,means,h,gnames] = multcompareSGP(stats,varargin)
...
%   $Revision: 1.1.8.2 $  $Date: 2010/10/08 17:25:08 $

% Check inputs and assign default values
if (nargin < 1)
   error(message('stats:multcompare:TooFewInputs'));
end
...
if (dodisp)
   ...
   halfwidth = crit * w(:);
   hh = meansgraphSGP(gmeans, gmeans-halfwidth, gmeans+halfwidth, ...
                   gnames, mname);
